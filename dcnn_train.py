...
class DynamicConvFoldingPoolLayer(object):
    ...
    def __init__(self, 
                 ...
                 k_top,
                 length_x,
                 number_of_convolutinal_layer,
                 index_of_convolitonal_layer,
                 activation = "tanh",
                 norm_w = False,
                 fold = 0,
                 W = None,
        ...
        self.input = input
        # self.k = k
        self.k = self.dynamic_k(length_x, number_of_convolutinal_layer,index_of_convolitonal_layer,k_top)
        # self.k = T.cast(length_x,'int64').eval() - 3.0
        # self.k = length_x - 4
        ...
        if W is not None:
            ...
            if norm_w:
                ...
                fan_out = (filter_shape[0] * np.prod(filter_shape[2:]) / self.k) # it's 
